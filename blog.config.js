...
const BLOG = {
  AUTHOR: 'Chih Han Liu', // 作者
  BIO: '愛分享及接觸新玩意的jii 哥', // 作者简介
  LINK: 'https://idv.sinica.edu.tw/', // 网站地址
  KEYWORDS: 'Notion, Blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID: 
  process.env.NOTION_PAGE_ID || '748da449ae0c42609e8c71c3ab49dc46', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
